...
jQuery(document).ready(function() {
  ...
  options.common = {
    debug: true,
    onLoad: function() {
      $('#messages').text("Começe a digitar a senha");
    }
  };
  $('.form-senha').pwstrength(options);
});
...
defaultOptions.ui.errorMessages = {
    wordLength: "A senha é muito curta",
    wordNotEmail: "Não use o email como senha",
    wordSimilarToUsername: "A senha não pode conter seu nome",
    wordTwoCharacterClasses: "Use diferentes classes de caracteres",
    wordRepetitions: "Muitas repetições",
    wordSequences: "A senha contêm sequências"
};
defaultOptions.ui.verdicts = ["Fraca", "Normal", "Mediana", "Forte", "Muito Forte"];
